# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-11-23 18:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='content_type_set_for_commentanswer', to='contenttypes.ContentType', verbose_name='content type')),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='blog.CommentAnswer')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sites.Site')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='commentanswer_comments', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
